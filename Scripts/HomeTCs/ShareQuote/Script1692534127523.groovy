...
Mobile.tap(findTestObject('Object Repository/HomeElements/ShareButton'), 5)

Mobile.verifyElementVisible(findTestObject('Object Repository/HomeElements/ShareFreame'), 0)
