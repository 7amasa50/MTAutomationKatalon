...
Mobile.tap(findTestObject('Object Repository/HomeElements/SearchButton'), 5)

Mobile.sendKeys(findTestObject('Object Repository/HomeElements/SearchQuoteTextArea'), GlobalVariable.Quote)

Mobile.tap(findTestObject('Object Repository/HomeElements/FirstQuoteWhenSearching'), 5)

Thread.sleep(2000)

Mobile.tap(findTestObject('Object Repository/HomeElements/FavouriteButton'), 5)

Mobile.tap(findTestObject('Object Repository/HomeElements/FavouriteButtonBottom'), 5)

Mobile.verifyElementNotVisible(findTestObject('Object Repository/FavouritesElements/ImageWhenFavouritesIsEmpty'), 5)
