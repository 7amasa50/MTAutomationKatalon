...
Mobile.tap(findTestObject('Object Repository/HomeElements/EditButton'), 5)

Mobile.verifyElementVisible(findTestObject('Object Repository/HomeElements/EditLabel'), 0)



//Can not be automated after that