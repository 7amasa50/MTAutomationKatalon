...
Mobile.tap(findTestObject('Object Repository/MoreElements/CategoryButtonOnMore'), 5)

Mobile.verifyElementVisible(findTestObject('Object Repository/CategoriesElements/CategoriesLabel'), 0)
