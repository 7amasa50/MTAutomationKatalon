...
Mobile.tap(findTestObject('Object Repository/MoreElements/BackgroundsButtonOnMore'), 5)

Mobile.verifyElementVisible(findTestObject('Object Repository/MoreElements/BackgroundsLabel'), 0)
