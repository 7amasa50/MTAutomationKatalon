...
Mobile.tap(findTestObject('Object Repository/MoreElements/WidgetsButtonOnMore'), 5)

Mobile.tap(findTestObject('Object Repository/MoreElements/WidgetElements/Never'), 0)

Mobile.tap(findTestObject('Object Repository/MoreElements/WidgetElements/Every 24 hours'), 0)

Mobile.tap(findTestObject('Object Repository/MoreElements/WidgetElements/Every 12 hours'), 0)
Mobile.tap(findTestObject('Object Repository/MoreElements/WidgetElements/Every 6 hours'), 0)
Mobile.tap(findTestObject('Object Repository/MoreElements/WidgetElements/Every 2 hours'), 0)
Mobile.tap(findTestObject('Object Repository/MoreElements/WidgetElements/Every 1 hour'), 0)
Mobile.tap(findTestObject('Object Repository/MoreElements/WidgetElements/Every 30 minutes'), 0)
