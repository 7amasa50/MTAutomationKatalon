...
Mobile.tap(findTestObject('Object Repository/MoreElements/WidgetElements/How to set widget'), 5)

Mobile.verifyElementVisible(findTestObject('Object Repository/MoreElements/WidgetElements/VideoViewOfHowSetWidget'), 0)
