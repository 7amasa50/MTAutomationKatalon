...
if (Mobile.verifyElementVisible(findTestObject('Object Repository/HomeElements/GotItOnSwipeButton'), 5, FailureHandling.OPTIONAL)) {
	...
	Mobile.tap(findTestObject('Object Repository/MoreElements/GiveUsFeedbackButtonOnMore'), 5)
	
	Mobile.tap(findTestObject('Object Repository/MoreElements/Feedback/5'), 5)
	
	Mobile.sendKeys(findTestObject('Object Repository/MoreElements/Feedback/FeedbackText'), 'Great app')
	
	Mobile.tap(findTestObject('Object Repository/MoreElements/Feedback/SubmitFeedbackButton'), 5)
	
	Mobile.verifyElementVisible(findTestObject('Object Repository/MoreElements/Feedback/Thank you for your Feedback'), 0)