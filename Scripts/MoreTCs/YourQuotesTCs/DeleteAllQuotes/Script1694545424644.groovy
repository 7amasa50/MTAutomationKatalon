...
Mobile.tap(findTestObject('Object Repository/MoreElements/YourQuotes/DELETEALLButton'), 5)
Mobile.tap(findTestObject('Object Repository/MoreElements/YourQuotes/ClearListWhenDeletingAllQuotes'), 5)

Mobile.verifyElementVisible(findTestObject('Object Repository/MoreElements/YourQuotes/NothingHereYet'), 0)
