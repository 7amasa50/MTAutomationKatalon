...
Mobile.tap(findTestObject('Object Repository/MoreElements/ShowDialogSwipesTriggerOnMore'), 5)

Mobile.tap(findTestObject('Object Repository/HomeElements/HomeButton'), 5)


for (num in 1..20) {
	Mobile.tap(findTestObject('Object Repository/HomeElements/SwipeDown'), 5)
	if(Mobile.verifyElementVisible(findTestObject('Object Repository/HomeElements/DialogSwipes'),1,FailureHandling.OPTIONAL))
	{
		flag= false ;
		break;
	}
		}
		Mobile.verifyEqual(flag, true)
