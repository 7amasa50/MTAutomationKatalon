...
if(Mobile.verifyElementVisible(findTestObject('Object Repository/MoreElements/NotificationsElements/NotificationItSelf'), 0,FailureHandling.OPTIONAL)
)
{
	Mobile.tap(findTestObject('Object Repository/MoreElements/NotificationsElements/AddNewNotification'), 0)
	Mobile.verifyElementVisible(findTestObject('Object Repository/MoreElements/NotificationsElements/UpgradeButtonWhenClickAddingNotification'), 0)
}