...
Mobile.tap(findTestObject('Object Repository/MoreElements/HistoryElements/DELETE ALL'), 5)

Mobile.tap(findTestObject('Object Repository/MoreElements/HistoryElements/ConfirmDeleteButton'), 5)
Mobile.tap(findTestObject('Object Repository/FavouritesElements/GoToQuotesButton'), 5)
Thread.sleep(2000)

String quoteOnHome= Mobile.getText(findTestObject('Object Repository/HomeElements/Quote'), 5)
...
Mobile.verifyEqual(quoteOnHome, quoteOnHistory)