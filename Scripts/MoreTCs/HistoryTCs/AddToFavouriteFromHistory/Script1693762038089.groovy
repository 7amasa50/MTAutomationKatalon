...
Mobile.tap(findTestObject('Object Repository/MoreElements/HistoryButtonOnMore'), 5)

String quoteOnHistory =  Mobile.getText(findTestObject('Object Repository/MoreElements/HistoryElements/FirstQuote'), 5)


Mobile.tap(findTestObject('Object Repository/MoreElements/HistoryElements/FavButton'), 5)

Mobile.tap(findTestObject('Object Repository/MoreElements/HistoryElements/BackButton'), 5)

Mobile.tap(findTestObject('Object Repository/MoreElements/FavouritesButtonOnMore'), 5)


String quoteOnFav =  Mobile.getText(findTestObject('Object Repository/FavouritesElements/FirstQuoteOnFav'), 5)
Mobile.verifyEqual(quoteOnFav, quoteOnHistory)