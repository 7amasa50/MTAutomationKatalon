...
Mobile.sendKeys(findTestObject('Object Repository/CategoriesElements/SearchInCategories'),  GlobalVariable.LockedCategory)

Mobile.hideKeyboard()


Mobile.verifyElementVisible(findTestObject('Object Repository/CategoriesElements/CategoryLocked(Affrimations)'), 0)