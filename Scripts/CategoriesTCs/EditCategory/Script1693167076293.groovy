...
Mobile.tap(findTestObject('Object Repository/CategoriesElements/OptionsOnCategory'), 5)

Mobile.tap(findTestObject('Object Repository/CategoriesElements/EditCategotyButton'), 5)

Mobile.sendKeys(findTestObject('Object Repository/CategoriesElements/CategoryNameWhenEditting'), GlobalVariable.NewCategoryName)

Mobile.hideKeyboard()


Mobile.tap(findTestObject('Object Repository/CategoriesElements/SaveButtonWhenEditting'), 5)

Mobile.sendKeys(findTestObject('Object Repository/CategoriesElements/SearchInCategories'),  GlobalVariable.NewCategoryName)
...
String ActualCategory = Mobile.getText(findTestObject('Object Repository/CategoriesElements/CategoryNameAfterSeaching'), 0)

Mobile.verifyEqual( GlobalVariable.NewCategoryName, ActualCategory)
