...
Mobile.tap(findTestObject('Object Repository/CategoriesElements/DeleteCategotyButton'), 5)

Mobile.tap(findTestObject('Object Repository/CategoriesElements/DeleteToConfirmDeletingCategory'), 5)

Mobile.verifyElementNotVisible(findTestObject('Object Repository/CategoriesElements/CategoryNameAfterSeaching'), 5)