...
Mobile.sendKeys(findTestObject('Object Repository/CategoriesElements/SearchInCategories'), 'FalsePositiveError')
Mobile.hideKeyboard()
Mobile.verifyElementVisible(findTestObject('Object Repository/CategoriesElements/NotFoundCategoriesWhenSearching'), 0)
