...
Mobile.tap(findTestObject('Object Repository/FavouritesElements/ShareButton'), 5)

Mobile.verifyElementVisible(findTestObject('Object Repository/FavouritesElements/ShareFrame'), 0)